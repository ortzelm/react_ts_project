...
import { Box, Container, Heading, Button, SimpleGrid, HStack, VStack, Drawer, DrawerBody, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerContent, DrawerCloseButton, useDisclosure, FormControl, FormLabel, Input, Switch, useToast, Text, Spinner, } from '@chakra-ui/react';
...
function App() {
  ...
  // Error state
  // Error state – fancy card version
  if (isError) {
    return (
        ...
        >
          <VStack spacing={4} align="center">
            ...
            <Text fontSize="md" color="red.800">
              {error instanceof Error ? error.message : 'Unknown error occurred while fetching employees.'}
            </Text>
            <Button
              leftIcon={<RepeatIcon />}
              colorScheme="red"
